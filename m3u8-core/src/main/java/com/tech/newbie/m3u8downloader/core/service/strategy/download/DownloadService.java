...
public abstract class DownloadService {
    protected final UpdateCallback<String> statusUpdateStrategy;
    protected final UpdateCallback<Double> progressUpdateStrategy;
    ...
    protected DownloadService(UpdateCallback<String> statusUpdateStrategy,
